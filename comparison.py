...
time_ns = time_ns*m_total*m_solar*G*1000/(c**3) #time in ms
scaled_signal_ns = signal_ns.real/signal_ns.real[0]

bhbh.graphs(waveform='psi4', plot_start=50, ring_start=50, fit_length=50, plot=False) #different ring_start, potential problem
